function T = getTrapMotherCellLineageGrowthRatesOLD(expInfoObj,window,fittype,switchFrame,dt,strain,posRange,yThresh)
    ...
    parfor trap = 1:nGrowthChannels
        ...
        if any(ind)
            if meanshifty>0
                ...
                trapMotherCellIds = find(cellTraps==trap & cellYcoord<yCutOff); % could add isDividing
            else
